 ...
 * [POURQUOI] RS256 pour l'access token (asymétrique → vérifiable par des
 * services tiers
 * sans exposer la clé privée). HS256 pour le refresh token (symétrique, plus
 * simple,
...
public class JwtService {
  ...
  // TODO: this function maybe should be private
  @PostConstruct
  public void init() {
    // TODO: this should be looged
    try {
