...
public class AuthService {
    ...
    public AuthResponse login(LoginRequest request, String clientIp) {
        ...
        if (user.getProvider() == Provider.GOOGLE) {
            throw new IllegalArgumentException("Ce compte utilise la connexion Google. Utilisez le bouton Google pour vous connecter.");
        }
    ...
    public MessageResponse forgotPassword(ForgotPasswordRequest request) {
        ...
        if (user.getProvider() == Provider.GOOGLE) {
            throw new IllegalArgumentException("Ce compte utilise la connexion Google. La réinitialisation du mot de passe n'est pas disponible.");
        }
    ...
    /**
     * S'assure que le pseudo est unique en ajoutant un suffixe numérique si nécessaire.
     */
